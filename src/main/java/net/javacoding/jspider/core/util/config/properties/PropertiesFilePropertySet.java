...
public class PropertiesFilePropertySet implements PropertySet {
    ...
    private PropertiesFilePropertySet(String fileName ) {
    ...
    public synchronized static PropertySet getInstance(String fileName) {
            if (instances.get(fileName) == null) {
                instances.put(fileName, new PropertiesFilePropertySet(fileName));
            }
