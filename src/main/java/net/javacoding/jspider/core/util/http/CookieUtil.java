...
public class CookieUtil {
    ...
    public Cookie[] getCookies(List<Header> headers) {
        String[] cookieStrings = getCookieStrings(headers);
        return getCookies(cookieStrings);
    }
    
    /**
     * 从httpclient header里获取数据
     * @param headers
     * @return
     */
    protected String[] getCookieStrings(List<Header> headers) {
