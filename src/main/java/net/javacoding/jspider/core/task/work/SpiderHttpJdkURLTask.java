 ...
 */
public class SpiderHttpJdkURLTask extends BaseWorkerTaskImpl {

    protected URL url;
    protected Site site;


    public SpiderHttpJdkURLTask(SpiderContext context, URL url, Site site) {
        ...
        try {
            ...
            if (inputStream != null) {
                try {
                    ...
                    LogFactory.getLog(SpiderHttpJdkURLTask.class).error("i/o exception closing inputstream",e);
                }
            }
        }
    }
